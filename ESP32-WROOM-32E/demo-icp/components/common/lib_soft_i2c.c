...
#define ESP32_I2C_SDA_PIN  GPIO_NUM_21
#define ESP32_I2C_SCL_PIN  GPIO_NUM_22

void probe_i2c_bus_init()
{
    lib_soft_i2c_cfg_t eepro_cfg;
    eepro_cfg.scl_gpio = ESP32_I2C_SDA_PIN;   //gpio2
    eepro_cfg.sda_gpio = ESP32_I2C_SCL_PIN;   //gpio3
